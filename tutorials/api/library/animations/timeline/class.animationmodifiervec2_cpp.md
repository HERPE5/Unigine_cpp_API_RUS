# Unigine::AnimationModifierVec2 Class (CPP)
...
## AnimationModifierVec2 ( AnimParams::PARAM param , const char * param_name )
...
## AnimationModifierVec2 ( const char * param )
...
## AnimationModifierVec2 ( const char * param , int param_index )
...
## AnimationModifierVec2 ( const char * param , const char * param_name )
...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationModifierVec2](../../../../api/library/animations/timeline/class.animationmodifiervec2_cpp.md)> &* **modifier** - Исходный модификатор анимации.
...
- *float* **time** - Время ключа на временной шкале, в секундах.
- *const  Math::[Vec2](../../../../api/library/math/class.vec2_cpp.md) &* **value** - Значение модификатора в указанный момент времени.
