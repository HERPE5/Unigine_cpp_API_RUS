...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationModifierFVec2](../../../../api/library/animations/timeline/class.animationmodifierfvec2_cpp.md)> &* **modifier** - Исходный модификатор анимации.
