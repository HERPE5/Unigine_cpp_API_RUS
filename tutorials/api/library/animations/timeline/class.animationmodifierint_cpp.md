...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationCurveInt](../../../../api/library/animations/timeline/class.animationcurveint_cpp.md)>&* **curve** - Кривая, хранящая значения, используемые модификатором.
...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationModifierInt](../../../../api/library/animations/timeline/class.animationmodifierint_cpp.md)> &* **modifier** - Исходный модификатор анимации.
...
- *float* **time** - Время ключа на временной шкале, в секундах.
- *int* **value** - Значение модификатора в указанный момент времени.
