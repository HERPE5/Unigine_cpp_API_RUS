...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationModifierIVec4](../../../../api/library/animations/timeline/class.animationmodifierivec4_cpp.md)> &* **modifier** - Исходный модификатор анимации.
...
- *float* **time** - Время ключа на временной шкале, в секундах.
- *const  Math::[ivec4](../../../../api/library/math/class.ivec4_cpp.md) &* **value** - Значение модификатора в указанный момент времени.
