...
Этот класс представляет собой интерфейс, позволяющий создавать кривые анимации, содержащие булевы значения, и управлять ими.
...
Конструктор. Создаёт новый экземпляр булевой кривой анимации.
...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationCurveBool](../../../../api/library/animations/timeline/class.animationcurvebool_cpp.md)> &* **curve** - Исходная кривая.
...
- *bool* **value** - Булево значение ключа.
...
Возвращает значение по умолчанию для всех ключей на кривой.
### Возвращаемое значение

Значение по умолчанию для всех ключей на кривой.
...
Значение кривой в указанной точке.
