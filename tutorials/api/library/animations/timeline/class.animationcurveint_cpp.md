# Unigine::AnimationCurveInt Class (CPP)
...
Этот класс представляет собой интерфейс, позволяющий создавать кривые анимации, содержащие целочисленные значения, и управлять ими.
...
Конструктор. Создаёт новый экземпляр кривой анимации, содержащей целочисленные значения.
## void copy ( const Ptr < AnimationCurveInt > & curve )

Копирует все данные (ключевые точки и касательные) из указанной исходной кривой.
### Аргументы

- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationCurveInt](../../../../api/library/animations/timeline/class.animationcurveint_cpp.md)> &* **curve** - Исходная кривая.
...
- *int* **value** - Целочисленное значение ключа.
