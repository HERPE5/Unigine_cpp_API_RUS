# Классы, связанные с анимацией


UNIGINE предоставляет две подсистемы анимации:


- **Timeline Animation** — система секвенсора/таймлайна для анимации произвольных свойств объектов (трансформаций узлов, параметров материалов, значений свойств) во времени с использованием кривых с ключевыми кадрами. Анимации таймлайна хранятся в файлах `*.utrack` и `*.uplay` и воспроизводятся через [NodeAnimationPlayback](../../../api/library/nodes/class.nodeanimationplayback_cpp.md).
- **Skeletal Animation** — система для деформации скиновых мешей с помощью скелета (иерархии суставов). Она включает управление скелетом и позами, воспроизведение клипов анимации, графы анимации с деревьями блендинга и конечными автоматами, а также ретаргетинг между различными скелетами.
