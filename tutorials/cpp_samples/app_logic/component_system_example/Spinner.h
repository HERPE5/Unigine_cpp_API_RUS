...
// Вращающееся препятствие, создающее снаряды через случайные интервалы.
// Демонстрирует анимацию параметров материала (циклическая смена цвета через HSV),
// клонирование узлов во время выполнения и изменение свойств компонентов.
...
private:
	// Преобразует цветовую модель HSV в RGB
