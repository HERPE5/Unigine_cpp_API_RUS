// UI примера для настройки параметров камеры spectator: чувствительность мыши,
// скорость поворота, базовая скорость и скорость спринта. Также предоставляет переключатели
// для управления вводом и определения столкновений.
...
// Получает ссылку на SpectatorController, настраивает режим мыши, считывает начальные значения
// параметров и создаёт GUI со слайдерами и чекбоксами для настройки во время выполнения.
...
// Восстанавливает исходный режим мыши и очищает GUI.
