...
// Метка расстояния обновляется каждый кадр, отражая движение камеры.
...
// Окно GUI строится с метками имени цели, расстояния и физического размера.
void TargetGui::init()
{
	...
	// Крупный шрифт (50) обеспечивает читаемость на расстоянии при увеличении
