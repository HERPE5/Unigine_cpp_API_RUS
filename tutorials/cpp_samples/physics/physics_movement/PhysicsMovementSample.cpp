// Предоставляет UI для настройки параметров PhysicsMover. Слайдеры изменяют силу,
// крутящий момент, импульс, ограничения скорости и торможение в реальном времени.
...
// Компонент PhysicsMover получается, UI инициализируется.
...
// Слайдеры параметров создаются для настройки движения.
