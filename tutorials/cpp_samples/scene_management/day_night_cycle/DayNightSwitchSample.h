...
// Контроллер примера для демонстрации цикла день/ночь.
// Показывает два метода переключения: пороговый угол зенита (позиция солнца)
// и управление по времени (утренние/вечерние границы).
// Предоставляет ползунки UI для настройки времени солнца, масштаба времени и параметров переключения.
