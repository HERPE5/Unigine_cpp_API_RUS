...
{
	// Отрисовываем координатные оси в позиции каждого персонажа для визуального ориентира
...
{
	// Применяем накопленный root motion для перемещения объекта в мировом пространстве.
	// Выполняется в post_update, чтобы гарантировать завершение обработки анимации.
