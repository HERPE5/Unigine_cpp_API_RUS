...
// Демонстрирует обработку ввода с клавиатуры и мыши.
// Отслеживает состояния кнопок/клавиш (down, pressed, up) между кадрами, захватывает текстовый ввод
// через события юникода, и отслеживает позицию мыши, дельту движения и прокрутку колеса.
// Состояния нажатия отслеживаются в HashSet для отображения всех удерживаемых в данный момент вводов.
