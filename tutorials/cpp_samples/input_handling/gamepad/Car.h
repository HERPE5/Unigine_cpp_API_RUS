...
// Простой контроллер транспортного средства, использующий физику JointWheel для симуляции колёс.
// Получает от обработчиков ввода скорость, угол поворота руля и торможение.
// Реализует геометрию поворота Аккермана через параметры carBase/carWidth
// для вычисления правильных углов внутреннего/внешнего колёс при повороте.
