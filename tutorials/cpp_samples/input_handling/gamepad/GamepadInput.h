...
// Демонстрирует обработку ввода геймпада с состояниями кнопок, аналоговыми осями и триггерами.
// Считывает движения левого/правого стика и значения триггеров, сопоставляет их с управлением автомобилем
// и поддерживает вибрационную обратную связь с настраиваемыми моторами низкой/высокой частоты.
// Также включена визуализация тач-ввода для геймпадов с поддержкой тачпада.
