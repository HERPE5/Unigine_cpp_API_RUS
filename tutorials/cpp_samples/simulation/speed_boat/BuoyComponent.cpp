...
void BuoyComponent::update()
{
	...
	if (water)
	{
		...
		// получаем высоту воды в позиции объекта
		...
		// вычисляем новый базис для изменённой точки
