// UI примера для управления отладочным рендерингом Visualizer. Предоставляет переключатели
// для включения/отключения визуализатора, теста глубины и отдельных 2D-примитивов
// (точки, линии, треугольники, квады, прямоугольники, сообщения).
...
void VisualizerSample::init()
{
	...
	// Чекбокс включения визуализатора
	...
	// Переключение режима теста глубины для визуализатора
	...
	// Управление отдельными переключателями 2D-визуализации с помощью чекбоксов с событиями
