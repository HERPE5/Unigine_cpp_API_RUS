...
public:
	...
	COMPONENT_DESCRIPTION("Demonstrates UNIGINE Microprofiler usage with macros "
							"and API calls across component lifecycle stages.");

	// Привязки жизненного цикла с примерами профилирования:
	// Каждый этап содержит искусственные задержки (sleepFor)
	// и макросы/методы профилирования в реализации.
	COMPONENT_INIT(init);
